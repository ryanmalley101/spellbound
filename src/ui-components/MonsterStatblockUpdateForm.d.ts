...
export declare type MonsterStatblockUpdateFormInputValues = {
    ownerId?: string;
    name?: string;
    createdAt?: string;
    updatedAt?: string;
...
export declare type MonsterStatblockUpdateFormValidationValues = {
...
export declare type MonsterStatblockUpdateFormOverridesProps = {
    MonsterStatblockUpdateFormGrid?: PrimitiveOverrideProps<GridProps>;
...
export declare type MonsterStatblockUpdateFormProps = React.PropsWithChildren<{
    overrides?: MonsterStatblockUpdateFormOverridesProps | undefined | null;
} & {
    id?: {
        id: string;
        ownerId: string;
    };
    monsterStatblock?: any;
    onSubmit?: (fields: MonsterStatblockUpdateFormInputValues) => MonsterStatblockUpdateFormInputValues;
    onSuccess?: (fields: MonsterStatblockUpdateFormInputValues) => void;
    onError?: (fields: MonsterStatblockUpdateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: MonsterStatblockUpdateFormInputValues) => MonsterStatblockUpdateFormInputValues;
    onValidate?: MonsterStatblockUpdateFormValidationValues;
} & React.CSSProperties>;
export default function MonsterStatblockUpdateForm(props: MonsterStatblockUpdateFormProps): React.ReactElement;
