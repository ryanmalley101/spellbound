...
export default function MessageCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setAdvantage(initialValues.advantage);
    setDamageDice(initialValues.damageDice);
    setCurrentDamageDiceValue("");
    setDamageDiceResults(initialValues.damageDiceResults);
    setCurrentDamageDiceResultsValue("");
    setRolls(initialValues.rolls);
    setCurrentRollsValue("");
    setAbilityName(initialValues.abilityName);
    setSaveAbility(initialValues.saveAbility);
    setSaveScore(initialValues.saveScore);
    setMessageText(initialValues.messageText);
    setDiceString(initialValues.diceString);
