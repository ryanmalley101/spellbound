...
import { createMonsterStatblock } from "../graphql/mutations";
function ArrayField({
  items = [],
  onChange,
  label,
...
export default function MonsterStatblockCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setAlignment(initialValues.alignment);
    setArmor_class(initialValues.armor_class);
    setArmor_desc(initialValues.armor_desc);
    setCurrent_hit_points(initialValues.current_hit_points);
    setHit_points(initialValues.hit_points);
    setHit_dice_num(initialValues.hit_dice_num);
    setHit_dice(initialValues.hit_dice);
    setStrength(initialValues.strength);
    setDexterity(initialValues.dexterity);
    setConstitution(initialValues.constitution);
    setIntelligence(initialValues.intelligence);
    setWisdom(initialValues.wisdom);
    setCharisma(initialValues.charisma);
    setStrength_save(initialValues.strength_save);
    setDexterity_save(initialValues.dexterity_save);
    setConstitution_save(initialValues.constitution_save);
    setIntelligence_save(initialValues.intelligence_save);
    setWisdom_save(initialValues.wisdom_save);
    setCharisma_save(initialValues.charisma_save);
    setSave_proficiencies(initialValues.save_proficiencies);
    setCurrentSave_proficienciesValue("");
    setPerception(initialValues.perception);
    setDamage_vulnerabilities(initialValues.damage_vulnerabilities);
    setDamage_vulnerability_list(initialValues.damage_vulnerability_list);
    setCurrentDamage_vulnerability_listValue("");
    setDamage_resistances(initialValues.damage_resistances);
    setDamage_resistance_list(initialValues.damage_resistance_list);
    setCurrentDamage_resistance_listValue("");
    setDamage_immunities(initialValues.damage_immunities);
    setDamage_immunity_list(initialValues.damage_immunity_list);
    setCurrentDamage_immunity_listValue("");
    setCondition_immunities(initialValues.condition_immunities);
    setCondition_immunity_list(initialValues.condition_immunity_list);
    setCurrentCondition_immunity_listValue("");
    setBlindsight(initialValues.blindsight);
    setBlindBeyond(initialValues.blindBeyond);
    setDarkvision(initialValues.darkvision);
    setTremorsense(initialValues.tremorsense);
    setTruesight(initialValues.truesight);
    setSenses(initialValues.senses);
    setLanguages(initialValues.languages);
    setChallenge_rating(initialValues.challenge_rating);
    setCr(initialValues.cr);
    setLegendary_desc(initialValues.legendary_desc);
    setMythic_desc(initialValues.mythic_desc);
    setErrors({});
  };
  ...
  return (
    <Grid
      ...
      {...getOverrideProps(overrides, "MonsterStatblockCreateForm")}
      {...rest}
    >
      <TextField
        label="Owner id"
